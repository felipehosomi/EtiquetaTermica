...
namespace CVA.AddOn.Common.Controllers
{
    public class BusinessPlaceController : BaseController
    {
        ...
        /// <summary>
        /// Busca filiais que estão ativas
        /// </summary>
        /// <returns></returns>
        public List<BusinessPlaceModel> GetActiveBPList()
        {
            List<BusinessPlaceModel> bplList = this.RetrieveModelList<BusinessPlaceModel>("Disabled = 'N'");
            return bplList;
        }

        public BusinessPlaceModel GetBusinessPlace(int bplId)
        {
            BusinessPlaceModel model = this.RetrieveModel<BusinessPlaceModel>("BPlId = " + bplId);
            return model;
        }
        ...
        public List<BusinessPlaceModel> GetBPList()
        {
            return this.RetrieveModelList<BusinessPlaceModel>(String.Empty);
        }
