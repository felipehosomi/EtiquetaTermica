...
namespace CVA.AddOn.Common.Controllers
{
    ...
    {
        public static string GetLayoutReport(string reportName)
        {
        ...
        public static bool GetMenuReport(string docName)
        {
        ...
        public static string AddReportToForm(string reportFile, string reportName, string typeName, string addOnName, string addOnForm, string menuId)
        {
            ...
            {
                return ReportController.GetLayoutReport(reportName);
            }
        }
        #endregion
    }
